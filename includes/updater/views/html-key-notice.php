<div class="updated">
	...
	<p><?php printf( '<a href="%s">Please enter your licence key</a> in the plugin list below to get updates for "%s".', '#' . sanitize_title( $this->plugin_slug ), esc_html( $this->plugin_data['Name'] ) ); ?></p>
